...
class Config:
    ...
    num_class = 17
    img_path = os.path.join(coco_root_dir, 'COCO-Dataset', 'val2017')
    ...
    if use_GT_bbox:
        ...
        # if False, make sure you have downloaded the val_dets.json and place
        # it into annotation folder
        gt_path = os.path.join(coco_root_dir, 'COCO-Dataset', 'annotations',
            'val_dets.json')
    ori_gt_path = os.path.join(coco_root_dir, 'COCO-Dataset', 'annotations',
        'person_keypoints_val2017.json')

cfg = Config()
add_pypath(cfg.coco_root_dir)
# add_pypath(os.path.join(cfg.coco_root_dir, 'cocoapi/PythonAPI'))